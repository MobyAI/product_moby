...
import { Volume2, Mic, ChevronRight, AlertCircle, Check } from "lucide-react";
                    ...
                    {step === 1 && (
                        <>
                            ...
                            <p className="text-gray-600 mb-6">
                                Tap "Test" to check your speakers.{' '}
                                <a href="#" className="text-blue-600 underline">Need help?</a>
                            </p>
                            ...
                            {speakerTestPlayed && (
                                <div className="flex items-center gap-2 text-green-600 mb-4">
                                    ...
                                    <span className="text-sm">Speaker test completed</span>
                                </div>
                            )}

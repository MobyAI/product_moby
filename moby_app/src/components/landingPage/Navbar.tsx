  ...
  > = ({ variant = "primary", href = "#", children }) => (
    <Link href={href} scroll={false}>
      <span
        className={
          variant === "primary"
            ? "inline-flex items-center gap-2 rounded-2xl px-5 py-3 bg-white text-slate-900 shadow hover:shadow-md transition-shadow"
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mt-4 flex items-center justify-between rounded-2xl bg-white/40 backdrop-blur-xl border border-white/20 px-4 py-3">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <NavLink href="#features"><span className="text-black">Features</span></NavLink>
            <NavLink href="#how"><span className="text-black">How does it work?</span></NavLink>
          </nav>

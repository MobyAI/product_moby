  ...
  return (
    <div className="space-y-4">
      ...
      <div className="border border-gray-200 rounded-[10px] overflow-hidden">
        {Object.entries(pendingRoles).map(([char, role], index, array) => {
          ...
          return (
            <button
              ...
              disabled={isSaving}
              className={`
                w-full text-left px-5 py-2 text-sm font-semibold transition-all
